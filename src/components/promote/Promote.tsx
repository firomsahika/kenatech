...
export default function Promote() {
  return (
    <main className='w-full items-center justify-center font-poppins '>
      <div className='flex items-center justify-center md:gap-14 lg:gap-16 py-20'>
        ...
        <div className='flex flex-row px-32 gap-4 '>
           ...
           <button className=' z-10 rounded-full bg-white px-4 py-4 text-black shadow-md '>2k+</button>
           </div>
